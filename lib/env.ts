...
const envSchema = z.object({
  ...
  CUSTOMER_JWT_SECRET: z.string().min(16).optional(),
  ...
  CUSTOMER_HOST: z.string().default("www.chatandtip.com"),
  ROOT_HOST: z.string().default("chatandtip.com"),
  ADMIN_HOST: z.string().default("admin.chatandtip.com"),
  MPESA_ENABLED: z.string().default("true"),
  MPESA_CONFIG_SOURCE: z.enum(["env", "database"]).default("env"),
  MPESA_CONSUMER_KEY: z.string().optional(),
  MPESA_CONSUMER_SECRET: z.string().optional(),
  MPESA_PASSKEY: z.string().optional(),
  MPESA_SHORTCODE: z.string().optional(),
  MPESA_STORE_NUMBER: z.string().optional(),
  MPESA_SHORTCODE_TYPE: z.string().default("CustomerPayBillOnline"),
