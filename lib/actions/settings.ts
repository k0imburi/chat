...
const generalSchema = z.object({
  ...
  mpesaEnabled: z.coerce.boolean().optional(),
  stripeEnabled: z.coerce.boolean().optional(),
  stripeSecretKey: z.string().optional(),
  stripeWebhookSecret: z.string().optional(),
  paystackEnabled: z.coerce.boolean().optional(),
  paystackSecretKey: z.string().optional(),
  paystackPublicKey: z.string().optional(),
  paystackCardEnabled: z.coerce.boolean().optional(),
  paystackMpesaEnabled: z.coerce.boolean().optional(),
  flutterwaveEnabled: z.coerce.boolean().optional(),
  flutterwaveClientId: z.string().optional(),
  flutterwaveClientSecret: z.string().optional(),
  flutterwaveSecretHash: z.string().optional(),
  flutterwaveBaseUrl: z.string().optional(),
  flutterwaveCurrency: z.string().optional(),
  googlePlayEnabled: z.coerce.boolean().optional(),
  googlePlayPackageName: z.string().optional(),
  googlePlayServiceAccountJson: z.string().optional(),
...
export async function saveGeneralSettingsAction(
  ...
  try {
    ...
    withdrawalFeePercent: formData.get("withdrawalFeePercent"),
    ...
    paystackEnabled: formData.get("paystackEnabled") === "on",
    paystackSecretKey: formData.get("paystackSecretKey") || "",
    paystackPublicKey: formData.get("paystackPublicKey") || "",
    paystackCardEnabled: formData.get("paystackCardEnabled") === "on",
    paystackMpesaEnabled: formData.get("paystackMpesaEnabled") === "on",
    flutterwaveEnabled: formData.get("flutterwaveEnabled") === "on",
    flutterwaveClientId: formData.get("flutterwaveClientId") || "",
    flutterwaveClientSecret: formData.get("flutterwaveClientSecret") || "",
    flutterwaveSecretHash: formData.get("flutterwaveSecretHash") || "",
    flutterwaveBaseUrl: formData.get("flutterwaveBaseUrl") || "https://developersandbox-api.flutterwave.com",
    flutterwaveCurrency: formData.get("flutterwaveCurrency") || "KES",
    googlePlayEnabled: formData.get("googlePlayEnabled") === "on",
    googlePlayPackageName: formData.get("googlePlayPackageName") || "com.chatandtip.app",
    googlePlayServiceAccountJson: formData.get("googlePlayServiceAccountJson") || "",
